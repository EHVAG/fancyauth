...
module Murmur
{
	 ...
	 *  complete before continuing processing.
	 */
	["amd"] interface ServerContextCallback {
	 ...
	 *  deadlock the server.
	 */
	["amd"] interface ServerAuthenticator {
	 ...
	 *  own database.
	 */
	["amd"] interface ServerUpdatingAuthenticator extends ServerAuthenticator {
		/** Register a new user.
